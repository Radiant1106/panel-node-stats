module.exports = client => {
  ...
  if (debug === true) {
    ...
    console.log(chalk.magenta('[CyberStats Debug] ') + chalk.green('Debug Mode: ') + chalk.cyan('true'))
    console.log(chalk.magenta('[CyberStats Debug] ') + chalk.green('Debug Axios Mode: ') + chalk.cyan(debugerror))
    console.log(chalk.magenta('[CyberStats Debug] ') + chalk.green('Resource: ') + chalk.cyan(resource))
    console.log(chalk.magenta('[CyberStats Debug] ') + chalk.green('Custom Status: ') + chalk.cyan(enablecs))
    console.log(chalk.magenta('[CyberStats Debug] ') + chalk.green('Enable Timestamp: ') + chalk.cyan(enablets))
    console.log(chalk.magenta('[CyberStats Debug] ') + chalk.green('Enable Description: ') + chalk.cyan(enabledesc))
    console.log(chalk.magenta('[CyberStats Debug] ') + chalk.green('Enable Footer: ') + chalk.cyan(enablef))
  }
  ...
  if (enablecs === true) {
    ...
    client.user.setActivity(title + ' Stats', { type: 'WATCHING' })
  }

  console.log(chalk.red('=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+='))
  console.log(chalk.green('Name: ') + chalk.cyan('CyberStats'))
  ...
  console.log(chalk.green('Support: ') + chalk.cyan('https://discord.gg/nHZk4SkM3Q'))
  console.log(chalk.red('=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+=+='))
  ...
  setInterval(() => {
    if (isNaN(time)) return console.log(chalk.cyan('[CyberStats Checker] ') + chalk.red(time + ' is not a number!'))
    if (!hosturl.includes('.')) return console.log(chalk.cyan('[CyberStats Checker] ') + chalk.red(hosturl + ' is invalid url!'))
    if (adminapikey.length < 48) return console.log(chalk.cyan('[CyberStats Checker] ') + chalk.red('Invalid Admin Apikey!!'))
    ...
    axios(api + '/application/nodes/', {
        ...
        axios(api + '/application/nodes/' + id + '?include=servers,location,allocations', {
          ...
          axios(api + '/application/nodes/' + id + '/configuration', {
            ...
            axios(node.data.attributes.scheme + '://' + node.data.attributes.fqdn + ':' + node.data.attributes.daemon_listen + '/api/servers', {
              ...
              console.log(chalk.cyan('[CyberStats Checker] ') + chalk.red(node.data.attributes.name + ' is down!'))
              if (debugerror === true) console.log(chalk.magenta('[CyberStats Debug] ') + chalk.red(err) + chalk.cyan(' Need Support? https://discord.gg/zv6maQRah3'))
            ...
            console.log(chalk.magenta('[CyberStats Debug] ') + chalk.red(err) + chalk.cyan(' Need Support? https://discord.gg/zv6maQRah3'))
          })
        }).catch((err) => {
          console.log(chalk.magenta('[CyberStats Debug] ') + chalk.red(err) + chalk.cyan(' Need Support? https://discord.gg/zv6maQRah3'))
        })
      ...
      axios(api + '/application/servers', {
        ...
        console.log(chalk.cyan('[CyberStats Checker] ') + chalk.red('Panel is down'))
        if (debugerror === true) console.log(chalk.magenta('[CyberStats Debug] ') + err)
      })
      ...
      console.log(chalk.cyan(['[CyberStats Checker] ']) + chalk.green('Connected to ' + list.length + ' nodes'))
      let nodeCount = '[Total ' + list.length + ']'

      if (debug === true) console.log(chalk.magenta('[CyberStats Debug] ') + chalk.blue(nodes))
      if (nodes === undefined) {
        nodes = checking + ' Please wait ' + time + ' seconds'
        console.log(chalk.cyan(['[CyberStats Checker] ']) + chalk.yellow(checking + ' Please wait ' + time + ' seconds'))
      }
      ...
      console.log(chalk.cyan('[CyberStats Checker] ') + chalk.green('Posted Stats'))
      if (panel !== null) console.log(chalk.cyan('[CyberStats Checker] ') + chalk.green('Stats Updated'))
      console.log(chalk.cyan('[CyberStats Checker] ') + chalk.green('Updating Stats in ' + time + ' Seconds'))
